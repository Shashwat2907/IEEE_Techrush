...
export function BedIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7v11m0-4h18m0-7v11M3 11a4 4 0 014-4h10a4 4 0 014 4M7 7V5a1 1 0 011-1h8a1 1 0 011 1v2" />
    </svg>
  );
}

export function UtensilsIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 2v20M17 5v6a3 3 0 01-3 3v8M7 2v6a3 3 0 003 3v11M4 2v4a3 3 0 003 3" />
    </svg>
  );
}
...
export function CarIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 17a2 2 0 104 0m6 0a2 2 0 104 0m-14 0H3m18 0h-2m-14 0l1.5-6h11l1.5 6m-14 0h14M6 7l2-4h8l2 4" />
    </svg>
  );
}
...
export function FlagIcon({ className = "w-4 h-4" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 2H20a1 1 0 011 1v7a1 1 0 01-1 1h-6.5l-1-2H5a2 2 0 00-2 2z" />
    </svg>
  );
}
