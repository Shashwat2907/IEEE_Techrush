...
const CROWD_DESCRIPTIONS = {
  low: { label: 'Low Crowd', description: 'Peaceful and uncrowded — enjoy the space', color: '#5B8A5A', icon: '👤' },
  medium: { label: 'Moderate', description: 'Comfortably busy — expect some queues', color: '#C9A227', icon: '👥' },
  high: { label: 'High Crowd', description: 'Very popular right now — plan ahead', color: '#A34530', icon: '👥👥' },
};
